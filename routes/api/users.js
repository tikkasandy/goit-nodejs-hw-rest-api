...
const { joiSchema, joiSubscriptionSchema, joiReverifyEmailSchema } = require('../../models/user')
...
router.post('/verify', validation(joiReverifyEmailSchema), ctrlWrapper(controllers.reverifyEmail))
